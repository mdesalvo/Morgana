...
### 🎯 Major Feature: Cauldron Widget — Morgana Dropped Into Any Existing Site
Reaching Morgana from a browser has so far meant *being* Cauldron: the visitor had to land on the Blazor app. This release adds **Cauldron.Widget**, an embeddable launcher that puts a live Cauldron conversation into a page that already exists — whatever built it, JSP, PHP, ...
