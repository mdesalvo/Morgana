<table style="border:none;" width="100%">
  <tr>
    ...
    <td style="width:calc(100% - 256px);">
      <h1>Morgana</h1>
      <p><i>A magical witch assistant equipped with an enchanted grimoire — powered by AI, yet shaped by you: your domain, your agents, your tools...woven into its spells.</i></p>
      <p>
