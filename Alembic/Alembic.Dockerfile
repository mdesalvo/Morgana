...
# mirrored under /src so Alembic's ProjectReference to ../Morgana/Morgana.AI resolves and each
# project picks up its own Directory.Build.props (Alembic's, beside Alembic.csproj, vs the Morgana
# one that Morgana.AI and Morgana.Contracts inherit).
