...
# mirrored under /src so Distiller2's ProjectReference to ../../Morgana/Morgana.AI resolves,
# and each project picks up its own Directory.Build.props (Alembic's, found by walking up
# from Alembic/Distiller2/, vs the Morgana one that Morgana.AI and Morgana.Contracts inherit).
COPY ["Alembic/Distiller2/Distiller2.csproj", "Alembic/Distiller2/"]
...
RUN dotnet restore "Alembic/Distiller2/Distiller2.csproj"
...
# component is its own — the behavioural templates under Alembic/Distiller2/Harness/Templates,
...
WORKDIR "/src/Alembic/Distiller2"
RUN dotnet build "Distiller2.csproj" -c Release -o /app/build /p:InsideDockerBuild=true

# ==============================================================================
# STAGE 2: PUBLISH
# ==============================================================================
FROM build AS publish
RUN dotnet publish "Distiller2.csproj" -c Release -o /app/publish /p:UseAppHost=false /p:InsideDockerBuild=true
