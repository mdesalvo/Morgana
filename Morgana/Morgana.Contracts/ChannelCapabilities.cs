...
/// <summary>
/// Declares the expressive capabilities of a channel (the transport + client pair that ultimately renders Morgana's responses to an end user).
/// Producers of outbound messages (presenter, agents, supervisor) consult this contract to decide whether a feature can be used as-is or
/// must be degraded for the target channel.
/// </summary>
