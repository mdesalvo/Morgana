...
public static class Records
{
    ...
    /// through an <see cref="Interfaces.IChannelService"/>. Carries the full payload an actor
    /// needs to publish: text, quick replies, rich card, agent identity, error reason, and
    /// rendering metadata (message type, fading duration).
    /// </summary>
    /// <remarks>
    ...
    // RICH CARD SYSTEM
    // ==========================================================================
    // Add this section to Morgana.AI/Records.cs
