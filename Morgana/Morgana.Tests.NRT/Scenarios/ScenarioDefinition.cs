...
public sealed class ScenarioDefinition
{
    ...
    /// <summary>How many times to replay the conversation. Falls back to <c>Nrt:DefaultRuns</c>.</summary>
    public int? Runs { get; init; }

    /// <summary>
    /// How many of those runs must pass. Falls back to <c>Nrt:DefaultMinPasses</c>. The
