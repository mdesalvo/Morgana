...
namespace Morgana.AgentsFramework.Services;
...
/// Core Morgana system prompts embedded in Morgana.AI assembly.
...
public class ConfigurationPromptResolverService : IPromptResolverService
{
    ...
    /// <summary>
    /// Loads framework prompts from morgana.json embedded resource in Morgana.AI assembly.
    ...
    /// <list type="number">
    /// <item>Get executing assembly (Morgana.AI.dll)</item>
    ...
    /// Typical format: "Morgana.AI.Configuration.morgana.json" or similar.
