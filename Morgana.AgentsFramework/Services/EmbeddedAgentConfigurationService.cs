...
/// Solution Structure:
/// ├── Morgana/
/// │   └── (framework code, no agents.json)
/// ├── Morgana.AI/
/// │   └── morgana.json (framework prompts)
/// └── Morgana.ExampleAgents/
...
///
/// At runtime:
/// 1. PluginLoaderService loads Morgana.ExampleAgents.dll
/// 2. EmbeddedAgentConfigurationService scans all assemblies
/// 3. Finds agents.json in Morgana.ExampleAgents.dll
...
public class EmbeddedAgentConfigurationService : IAgentConfigurationService
{
    ...
    /// ✅ Found agents.json in assembly: Morgana.ExampleAgents
