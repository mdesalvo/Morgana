...
/// <summary>
/// Picks a random landing message from the <c>Grimoire:LandingMessages</c> configured pool
...
public sealed class LandingMessageService
{
    ...
    {
        landingMessages = configuration.GetSection("Grimoire:LandingMessages").Get<string[]>()
