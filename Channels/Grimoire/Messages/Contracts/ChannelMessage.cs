...
public sealed class ChannelMessage
{
    ...
    /// Grimoire uses this to drive the sticky header's colored speaker label.
    /// </summary>
    ...
    /// <summary>
    /// Duration of the eventual fading message — Grimoire ignores it since the CLI has no fading UI.
    /// </summary>
    ...
    /// conversation, not this message. Grimoire renders it in the sticky header.
