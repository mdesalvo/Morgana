...
/// <summary>
/// <para>
/// Capability descriptor declared by Grimoire at the conversation-start handshake.
...
{
    /// <summary>True if the channel can render rich card payloads. Required.</summary>
    public required bool SupportsRichCards { get; set; }

    /// <summary>True if the channel can render quick reply buttons. Required.</summary>
    public required bool SupportsQuickReplies { get; set; }

    /// <summary>True if the channel can consume real-time stream chunks. Required.</summary>
    public required bool SupportsStreaming { get; set; }

    /// <summary>True if the channel renders Markdown formatting in message text. Required.</summary>
