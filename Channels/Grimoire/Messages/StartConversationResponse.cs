...
/// conversation id Grimoire minted on the request plus an informational status message.
/// </summary>
/// <remarks>
...
{
    /// <summary>Conversation id echoed back by Morgana (same value Grimoire sent on the request).</summary>
