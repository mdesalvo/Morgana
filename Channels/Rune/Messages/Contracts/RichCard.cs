...
/// <summary>
/// Rich card container. Rune declares <c>SupportsRichCards=false</c> so this DTO should be
...
public enum TextStyle { Normal, Bold, Muted, Small }
public enum ListStyle { Bullet, Numbered, Plain }
public enum BadgeVariant { Success, Warning, Error, Info, Neutral }
