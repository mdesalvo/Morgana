...
/// <summary>
/// The dispatch agent of a nursery whose greenhouse stands at another site: it answers for deliveries
...
///
/// <para>Deliberately toolless. An agent with books of its own could answer from them and a turn that
...
{
    /// <summary>Builds the agent, with its colleague at the annex already in its tool list.</summary>
